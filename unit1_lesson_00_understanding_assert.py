...
-Assert statement working in case of truth value of an expression.
-Using Python interepreter to evaluate the tests,running single method tests.
-Working of ** and * operators difference between them.
"""