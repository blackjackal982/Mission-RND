...
-Using forums and google for understanding the flow of execution in exceptions
-Difference between use of else with for and try
-Use of finally and flow of control
"""
