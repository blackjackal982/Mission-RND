...
def test_function_call_with_keyword_arguments():
    assert [10,2,3,4] == demo(10,2) #TypeError: demo() missing 1 required positional argument: 'second' as there is no default value given we need to pass a value
    assert [10,20,3,4] == demo(10, 20)
    assert [10,20,30,4] == demo(10, 20, 30)
    assert [12,20,3,4] == demo(first=12,second=20)#TypeError: demo() missing 1 required positional argument: 'first' as there is no default value we have to pass
    assert [100,20,30,4] == demo(first=100,second=20, third=30)
    assert [10,209,30,4] == demo(first=10,second = 209, third=30)
    assert [10,20,30,4] == demo(10,second=20, third=30)
    assert [20,10,3,4] == demo(20, 10)  # is this allowed? correct and uncomment
...
def test_function_with_keyword_args():
    ...
    #here we are passing name="jack" which is a normal argument and we are returning kwargs
    #which will not return the normal argument hence empty dict
...
-working of the tuples and lists with default
-working of format
"""
